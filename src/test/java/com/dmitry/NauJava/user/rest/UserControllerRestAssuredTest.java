...
class UserControllerRestAssuredTest {
    private static final String BASE_USER_URL = "http://localhost:8081/api/v1/users";
    ...
    private String performFormLogin() {
        Response loginResponse = given()
                ...
                .formParam(EMAIL_FIELD, ADMIN_USERNAME)
                .formParam(PASSWORD_FIELD, ADMIN_PASSWORD)
    ...
    void createUserAPITest() {
        ...
        Map<String, Object> userDto = Map.of(
                EMAIL_FIELD, UUID.randomUUID() + "@mail.com",
                ROLES_FIELD, List.of("USER"),
    ...
    void createUserWithNullRolesAPITest() {
        // Подготовка
        Map<String, Object> userDto = Map.of(
                EMAIL_FIELD, "no.roles@example.com",
                PASSWORD_FIELD, ADMIN_PASSWORD
        );
